...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-64 bg-[var(--surface)] text-[var(--text-primary)] h-screen fixed left-0 top-0 overflow-y-auto pt-16 shadow-lg border-r border-[var(--border-light)] flex-col">
      ...
      <div className="md:hidden fixed left-0 top-16 z-40">
        <button
          ...
          className="p-3 bg-[var(--surface)] border-r border-[var(--border-light)] hover:bg-[var(--surface-secondary)] transition-colors"
        >
      ...
      {/* Mobile Menu */}
      <aside
        className={`md:hidden fixed left-0 top-16 w-64 bg-[var(--surface)] h-screen overflow-y-auto shadow-lg border-r border-[var(--border-light)] z-40 transform transition-transform duration-300 ${
